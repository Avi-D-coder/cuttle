...
## Rust Cutthroat Integration

Cutthroat (3P) runs on a Rust service under `/cutthroat/*`.

- Rust is optional for JS-first development.
- If Rust is unavailable, 2P gameplay remains fully functional.
- The UI hides Cutthroat entry points and redirects `/cutthroat/*` routes back to `/`.
